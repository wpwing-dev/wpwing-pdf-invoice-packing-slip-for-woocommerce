<?php
/**
 * Plugin Name: WPWing PDF Invoice Packing Slip for WooCommerce
 * Plugin URI: https://wpwing.com/
 * Description: Generate PDF invoices and packing slips for WooCommerce orders.
 * Version: 1.0.0
 * Author: wpwing, voboghure
