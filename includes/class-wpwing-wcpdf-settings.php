...
if ( ! class_exists( 'WPWing_WcPdf_Settings' ) ) {
	class WPWing_WcPdf_Settings {
		...
		public function add_settings() {
			...
			$this->add_setting( 'wpwing_pdf_general', esc_html__( 'General', 'wpwing-wcpdf' ), apply_filters( 'wpwing_wcpdf_general_settings_section', array(
				array(
					'title'  => esc_html__( 'General Section', 'wpwing-wcpdf' ),
					'desc'   => esc_html__( 'Basic settings for PDF Invoice', 'wpwing-wcpdf' ),
					'fields' => apply_filters( 'wpwing_wcpdf_general_settings_fields', array(
						array(
							'id'          => 'invoice_number',
							'type'        => 'text',
						...
						array(
							...
							// 'desc'        => esc_html__( 'Button behaviour', 'wpwing-wcpdf' ),
							'options'     => array(
			...
			$this->add_setting( 'wpwing_pdf_template', esc_html__( 'Template', 'wpwing-wcpdf' ), apply_filters( 'wpwing_wcpdf_template_settings_section', array(
				array(
					'title'  => esc_html__( 'Template Section', 'wpwing-wcpdf' ),
					'desc'   => esc_html__( 'Basic template for PDF Invoice', 'wpwing-wcpdf' ),
					'fields' => apply_filters( 'wpwing_wcpdf_template_settings_fields', array(
						array(
							'id'      => 'invoice_template',
							'type'    => 'select',
		...
		public function add_setting( $tab_id, $tab_title, $tab_sections, $active = false, $is_pro_tab = false, $is_new = false ) {
			add_filter( 'wpwing_wcpdf_settings', function ( $fields ) use ( $tab_id, $tab_title, $tab_sections, $active, $is_pro_tab, $is_new ) {
