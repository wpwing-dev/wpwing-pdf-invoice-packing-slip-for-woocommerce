...
if ( ! class_exists( 'WPWing_WcPdf_Settings' ) ) {
	class WPWing_WcPdf_Settings {
		...
		private function get_available_templates() {
			...
			return $templates ?: array( 'default' => 'Default' );
		}
		...
		private function add_general_settings( $order_statuses, $email_options ) {
			$this->add_setting(
				...
				apply_filters( 'wpwing_wcpdf_general_settings_section', array(
					array(
		...
		private function add_template_settings( $templates ) {
			$this->add_setting(
				...
				apply_filters( 'wpwing_wcpdf_template_settings_section', array(
					array(
